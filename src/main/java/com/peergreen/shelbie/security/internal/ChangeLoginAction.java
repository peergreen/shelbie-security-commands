 ...
 */
@Component
@Command(name = "change-login",
        scope = "security",
        description = "Change login of a given account.")
@HandlerDeclaration("<sh:command xmlns:sh='org.ow2.shelbie'/>")
public class ChangeLoginAction implements Action {
    ...
    public ChangeLoginAction(@Requires AccountStoreManager manager) {
    ...
    public Object execute(CommandSession session) throws Exception {
        ...
        try {
            ...
            System.out.printf("Attention, this will change the security identifier of '%s'%n", login);
            System.out.printf("Notice that currently open connections using this account will not be" +
                              "changed and will require a re-connection.%n");
            System.out.printf("  Enter new login: ");
            System.out.flush();
