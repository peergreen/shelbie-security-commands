 ...
 */
@Component
@Command(name = "remove-roles",
        scope = "security",
        description = "Removes roles from a given account.")
@HandlerDeclaration("<sh:command xmlns:sh='org.ow2.shelbie'/>")
public class RemoveRolesAction implements Action {
    ...
    @Argument(index = 1,
            ...
            required = true,
            multiValued = true,
            description = "List of roles to be removed from the account")
    private List<String> roles;

    public RemoveRolesAction(@Requires AccountStoreManager manager) {
